...
- (BOOL)loadShaders
{
    ...
    //uniforms[UNIFORM_ALPHA2] = glGetUniformLocation(_program, "alpha2");
...
-(void) drawShaderFullscreen {
    ...
    //glUniform1i(uniforms[UNIFORM_INPUT_IMAGE_TEXTURE], 0);
    //glBindTexture(GL_TEXTURE_2D, _textureBinding);
    glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_SHORT, qIndices);
}

- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
    float dT = [_sessionTimer elapsedSec];
    glClearColor(0.0f, 80.f/255.f, 174.f/255.f, 1.0f);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    glDisable(GL_DEPTH_TEST);
    glEnable(GL_BLEND);
    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    [self drawShaderFullscreen];
}
